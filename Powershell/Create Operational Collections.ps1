...
# Created : 2014/07/17
# Modified : 2014/08/14
#            - Added Collection 34,35,36
#Updated by : eswar Koneti (www.eskonr.com)
#            --added new collections 37,38,39,40
#
...
$Collection4 = @{Name = "All Clients Non R2 CU2"; Query = "select SMS_R_SYSTEM.ResourceID,SMS_R_SYSTEM.ResourceType,SMS_R_SYSTEM.Name,SMS_R_SYSTEM.SMSUniqueIdentifier,SMS_R_SYSTEM.ResourceDomainORWorkgroup,SMS_R_SYSTEM.Client from SMS_R_System where SMS_R_System.ClientVersion != '5.00.7958.1303'"}
...
$Collection23 = @{Name = "All SCCM Site Systems"; Query = "select SMS_R_System.ResourceId, SMS_R_System.ResourceType, SMS_R_System.Name, SMS_R_System.SMSUniqueIdentifier, SMS_R_System.ResourceDomainORWorkgroup, SMS_R_System.Client from  SMS_R_System where SMS_R_System.SystemRoles = 'SMS Site System'"}
$Collection24 = @{Name = "All SCCM Site Servers"; Query = "select SMS_R_System.ResourceId, SMS_R_System.ResourceType, SMS_R_System.Name, SMS_R_System.SMSUniqueIdentifier, SMS_R_System.ResourceDomainORWorkgroup, SMS_R_System.Client from  SMS_R_System where SMS_R_System.SystemRoles = 'SMS Site Server'"}
...
New-CMDeviceCollection -Name $Collection36.Name -LimitingCollectionName $LimitingCollection -RefreshSchedule $Schedule -RefreshType 2
Add-CMDeviceCollectionQueryMembershipRule -CollectionName $Collection36.Name -QueryExpression $Collection36.Query -RuleName $Collection37.Name

New-CMDeviceCollection -Name $Collection36.Name -LimitingCollectionName $LimitingCollection -RefreshSchedule $Schedule -RefreshType 2
Add-CMDeviceCollectionQueryMembershipRule -CollectionName $Collection36.Name -QueryExpression $Collection36.Query -RuleName $Collection38.Name

New-CMDeviceCollection -Name $Collection36.Name -LimitingCollectionName $LimitingCollection -RefreshSchedule $Schedule -RefreshType 2
Add-CMDeviceCollectionQueryMembershipRule -CollectionName $Collection36.Name -QueryExpression $Collection36.Query -RuleName $Collection39.Name

New-CMDeviceCollection -Name $Collection36.Name -LimitingCollectionName $LimitingCollection -RefreshSchedule $Schedule -RefreshType 2
Add-CMDeviceCollectionQueryMembershipRule -CollectionName $Collection36.Name -QueryExpression $Collection36.Query -RuleName $Collection40.Name
